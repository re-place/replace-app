...
// @ts-ignore
import { UpdateBookableEntityOrderDto } from '../model/updateBookableEntityOrderDto';
// @ts-ignore
...
export class DefaultService {
    ...
    /**
     * Updates the order of bookable entities
     * @param updateBookableEntityOrderDto 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public apiBookableEntityOrderPut(updateBookableEntityOrderDto?: UpdateBookableEntityOrderDto, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any>;
    public apiBookableEntityOrderPut(updateBookableEntityOrderDto?: UpdateBookableEntityOrderDto, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpResponse<any>>;
    public apiBookableEntityOrderPut(updateBookableEntityOrderDto?: UpdateBookableEntityOrderDto, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<HttpEvent<any>>;
    public apiBookableEntityOrderPut(updateBookableEntityOrderDto?: UpdateBookableEntityOrderDto, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext}): Observable<any> {
        ...
        let localVarPath = `/api/bookable-entity/order`;
        return this.httpClient.request<any>('put', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: updateBookableEntityOrderDto,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
                headers: localVarHeaders,
                observe: observe,
     ...
     * @param floorId The id of a floor
     * @param my If true, only bookings of the current user are returned
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public apiBookingByParamsGet(start?: string, end?: string, bookableEntityId?: string, floorId?: string, my?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<BookingDto>>;
    public apiBookingByParamsGet(start?: string, end?: string, bookableEntityId?: string, floorId?: string, my?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<BookingDto>>>;
    public apiBookingByParamsGet(start?: string, end?: string, bookableEntityId?: string, floorId?: string, my?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<BookingDto>>>;
    public apiBookingByParamsGet(start?: string, end?: string, bookableEntityId?: string, floorId?: string, my?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        let localVarPath = `/api/booking/byParams`;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiFloorFloorIdBookableEntityGet(floorId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<BookableEntityDto>>;
    public apiFloorFloorIdBookableEntityGet(floorId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<BookableEntityDto>>>;
    public apiFloorFloorIdBookableEntityGet(floorId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<BookableEntityDto>>>;
